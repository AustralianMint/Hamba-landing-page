        ...
        >
          ...
          <m.div variants={rise} className="mt-9">
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-full bg-foreground px-7 py-3.5 text-base font-medium text-background shadow-lg shadow-black/10 transition-[opacity,box-shadow,translate] duration-200 hover:-translate-y-0.5 hover:opacity-90 hover:shadow-xl focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent"
            >
              <svg
                aria-hidden="true"
                viewBox="0 0 384 512"
